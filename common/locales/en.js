export default {
	...
	entrust: {
		ckxq: 'View details',
		chedan: 'Cancel order',
		pingchang:'Liquidate positions',
		pingchangchenggong:'Successful liquidation',
		pd: 'Pingduo',
		pk: 'Flat air',
		kk: 'Open short',
		kd: 'Kaido',
	...
	financial: {
		...
		yingkuijine:'Proft and loss amount',
		caozuo:'Direction',
		zhuangtai:'Status',
		kaichangjine:'Amount',
		kepingjine:'Closable amount',
		baozhengjin:'Margin',
		shouxufei:'Handling fee',
		jianchangchengben:'Average',
		pingchangjiage:'Closing price',
		dingdanhao:'Order number',
		kaichangshijian:'Opening time',
	...
	pledgeIndex: {
		...
		dkbz: 'Loan Currency',
		zyl: 'Collateral Ratio',
		zfz: 'Total Liabilities',
		ywcqbjz: 'Already fully loaded',
		jxz: 'Interest Calculation in Progress',
		qpjq: 'Force Liquidation',
		qdl: 'Please Log In',
		yjq:'settled',
		gzsm: 'Rules Explanation',
		kejiejine: 'The maximum loan amount is equal to the collateral amount multiplied by the initial collateralization ratio.',
		bczyl: 'Additional Collateralization Ratio',
		ddjhzc: 'When (Order Loan Asset + Cumulative Interest) converted to collateral asset price / collateral asset value ≥ 75%, the system will remind you to add collateral assets or make early repayment based on the initial collateralization ratio.',
		pczyl: 'Liquidation Collateralization Ratio',
		ddjhzcjjlx: 'When (Order Loan Asset + Cumulative Interest) converted to collateral asset price / collateral asset value ≥ 83%, the system will automatically sell/deduct the pledged assets to repay the loan. Please replenish the pledged funds in a timely manner.',
		llfy: 'Interest Rate Expense',
		xsll: 'Hourly interest rate 0.2%; daily interest rate 4.8%; early repayment handling fee is calculated on an hourly basis, and if it is less than 1 hour, it will be calculated as 1 hour.',
		xy200: 'The borrowed amount cannot be less than 200.',
		dy0: 'Collateral must be greater than 0.',
		qxzzyb: 'Please select the collateral currency.',
		cckyye: 'Exceeding the available balance.',
		qdl: 'Please log in.',
		jbcg: 'Loan Successful',
		ddxq: 'Order Details',
		huankuan: 'Repayment',
		zjk: 'Total Borrowing Amount',
		shililv: 'Hourly Interest Rate/Daily Interest Rate',
		qiangpingjiage: 'Liquidation Price (BTC/USDT)',
		ddh: 'Order Number',
		jhsj: 'Borrowing Time',
		dqsj: 'Due Time',
		zyjl: 'Pledge Record',
		...
		lixi: 'Interest',
		bjhk: 'Principal Repayment',
		hhhzyl: 'Pledge Ratio After Repayment',
		querenhuankuan: 'Confirm Repayment',
		dyhkje: 'Greater than Repayment Amount',
		qsrhksl: 'Please enter the repayment amount',
	},
	withdraw: {
	...
	member: {
		...
		jymma: "Transaction password",
		badl: "Login",
		qsryxsjh: "Please enter your email/phone number",
		cjygbazh: "To register",
		wzdbazh: "MXO account not found",
		qsrsjhhyx: "Please enter your phone number",
		hyhl: "welcome back",
		dl: "Login",
		xzdq: "Select Region",
		ssw: "search for",
		zcg: "Registered",
		zc: "Register",
		yqsryxsjh: "Registered using mobile phone or email",  
		hyldba: "Welcome to MXO",
		dlcg: "Login succeeded",
		qsrdlmm: "Please enter your login password",
		qsrjymmaaa: "Please enter the transaction password",
		skjkjkhd: "Please enter your phone number",
		hujkjkh: "Please enter the correct email address",
		zccg: "login was successful",
		kigsdas: "Please enter your phone number or email address",
		xyb: "next step",
		zh: "account",
		yx: "email",
		sjh: "Phone number",
		mm: "password",
		szmm: "Set Password",
		szmmts: "Password (6-12 characters)",
		wyydbty: 'I have read and agree',
		fwtk: 'Terms of Service',
		qdl: 'Go to login',
		mmbyz:'Password does not match',
		qrmm: "Confirm Password",
		smrz: "KYC",
		aqbd: "Security Binding",
		yjy: "Cloud transaction",
		qjy: 'To tradeTo',
		yqm: "Invitation code",
		yqmxt: "Invitation code (optional)",
		qsryqm: "Please enter the invitation code",
		wyydbty: " I have read and agree",
		fwtk: "Terms of Service",
		tg: " Sign in",
		szzjmm: "Set fund password",
		zjmm: "placeholder='Fund password(6 digits)'",
		qrmm: "Confirm password",
		...
		qsrmm: "Please confirm the password",
		hmyzh: "No account yet？",
		yyzh: "Have an account？",
		qdl: " register ",
		tg:'Skip',
		sccg:'Upload succeeded',
		realName:'Please enter your real name',
		number:'Please enter your ID number',
		positiveLink:'Please upload a front photo',
		sideLink:'Please upload a reverse photo',
		handLink:'Please upload a handheld photo',
		tg:'Skip',
		qxzgj:'Please select a country',
		qsrgj:'Please enter the name of the country to search for',
		smrz:'Authentication',
		gj:'Nationality',
		zsmz:'Real name',
		zjz:'Certificate/Passport Number',
		zjzsc:'Certificate photo/upload passport',
		zjzm:'Front of certificate',
		zjfm:'Reverse side of certificate',
		zjsc:'Handheld ID photo',
		pssl:'Shooting Example',
		next:'Next step',
		srzsxm:'Please enter your real name',
		srzjhm:'Please enter your ID/passport number'
	},
	finish:{
		zccg:'Login was successful',
		szhbzl:'Start your digital currency journey',
		tyxtxxtz:'Agreed to authorize system information notification',
		tyfwdzp:'I have agreed to authorize access to the address book',
		wxymb:'I would like to buy coins',
		qjy:'To trade',
		qcz:'To recharge',
	...
	financialManagement: {
		...
		kyye: 'Available balance',
		slxz: 'Quantity limit',
		zskt: 'Minimum investment',
		zdkt: 'Maximum investment',
		gailan: 'Overview',
		gmr: 'Purchase date',
		qxr: 'Value date',
		pxsj: 'Dividend payment time',
		jxjsr: 'Interest calculation end date',
		tqsh: 'Early redemption',
		yjsy: 'Expected yield',
		jrrsy: 'Daily yield today',
		jebnxy0: 'Amount cannot be less than 0.',
		jebnxyzskt: 'Amount cannot be less than the minimum investment amount.',
		jebndyzdkt: 'Amount cannot be greater than the maximum investment amount.',
		lcje: 'Investment Amount (USDT)',
		yqsy: 'Expected Return',
		rsy: 'Daily Return',
		ddbh: 'Order Number',
		ddsj: 'Order Time',
		goumaichenggong: 'Purchase success',
		jrqkhdsyfc: 'You can receive profit sharing from now on',
		fhjy: 'Return to transaction',
		tgje:'Escrow amount (USDT)',
		tgsj:'Escrow time',
		drsy:'Daily earnings',
		yhsy:'Total earnings',
		syts:'Days remaining',
		...
		wyj:'Penalty (USDT)',
		shbj:'Redemption principal (USDT)',
		ddbh:'Order number',
		ddsj:'Order time',
		wysh:'Redeem now',
		shcg:'Redemption success',
		scje: 'Locked Amount (USDT)',
		scsj: 'Locking Time',
		drsj: 'Daily Earnings',
		yhsy: 'Accrued Earnings',
		syts: 'Remaining Days',
		tyqsy: 'Expected Earnings in 30 days',
		rsyl: 'Daily Yield',
		qxsj: 'Start Time',
		dqsj: 'Expiration Time',
		ddbh: 'Order Number',
	...
	miner:{//About miner
		ljzy:'Immediate Rental',
		tyqsy:'Expected Profit in Days',
		rsyl:'Daily Yield',
		xiane:'Limit',
		zhouqi:'Cycle',
		quanbu: 'All',
		...
		kyye: 'Available balance',
		slxz: 'Quantity limit',
		zskt: 'Minimum investment amount',
		zdkt: 'Maximum investment amount',
		gailan: 'Overview',
		gmr: 'Purchase date',
		...
		tyqsy: 'Expected earnings in 30 days',
		rsy: 'Daily earnings',
		qxjsr: 'Interest payment end date',
		ddbh: 'Order number',
		ddsj: 'Order time',
		queding: 'Confirm',
		quxiao: 'Cancel',
