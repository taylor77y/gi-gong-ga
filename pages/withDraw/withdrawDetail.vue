<template>
  <view class="container">
    <head-slot>
      <template #middle><text>提现 详情<!-- {{i18n.uHistory}} --></text></template>
    </head-slot>
    <view class="content-header">
      ...
      <view class="u-flex u-flex-col u-p-40 border-b-gray">
        ...
        <view class="u-m-10 u-font-sm"> 数字货币已经提现 确定中。您可以在钱包帐户中查看详情。  </view>
      </view>
      ...
      <view class="u-p-20  border-b-gray">
        ...
        <view class="u-flex u-row-between u-margin-bottom-30">
          ...
          <text>{{$u.timeFormat(item.extractTime, 'yyyy-mm-dd hh:MM:ss')}}</text>
        </view>
        <view class="u-flex u-row-between u-margin-bottom-30">
