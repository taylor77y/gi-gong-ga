<template>
	<view class="" style="background: #000;">
		<view class="pb-60 px-30">
			...
			<navigator :url="$store.state.token ? '/pages/setting/userInfo' : '/pages/login/login'" class="text-white d-flex align-items-center justify-content-between mt-30">
