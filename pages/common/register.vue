		...
		<view class="login-container text-white">
			...
			<view class="">
				...
				<view class="login-input-group">
					<input type="text" v-model="walletAddress" class="login-input" :placeholder="i18n.walletAddress">
				</view>
...
<script>
	...
	export default {
		...
		methods:{
			...
			async register(){
				let {loginActive,usestring,code,invitecode,walletAddress,password,re_password,i18n} = this
				
				//钱包地址非空判断
				if(!walletAddress){
					this.$utils.showToast(i18n.pleaseEnterWalletAddress)
					return false
				}
